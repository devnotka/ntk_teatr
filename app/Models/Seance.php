...
class Seance extends Model
{
	...
	*/
	...
	{
		return $this->belongsTo(Activity::class, 'activity_id', 'id')->orderBy('created_at', 'desc');
	}
	...
	public function getActualSeances()
	{
		...
		{
			if($actual_seance->activity->pro_culture_id === 0 || $actual_seance->activity->event->status === 'rejected')
			{
